...
<div class="row">
	...
	<div class="col-xs-4 deployed">
		...
		<input type="file" name="passport" class="form-control" <?if ($_SESSION["admin"]==0) echo "required";?>>
	</div>	
	<div class="col-xs-4 deployed">
...
<div class="row">
	<div class="col-xs-2 deployed">
		...
		<input type="text" name="us-login" class="form-control" placeholder="логин" value="<?if(isset($_POST['us-login'])){echo $_POST['us-login'];}else{echo $login;}?>" autocomplete="off" required>
		<div class="street_list">﻿<ul id='str_list'></ul></div>
	</div>
	<div class="col-xs-2 deployed">
		<label class="signature">Пароль</label>
		<input type="text" name="us-password" class="form-control" placeholder="пароль" value="<?if(isset($_POST['us-password'])) echo $_POST['us-password'];?>" autocomplete="off" required>
	</div>	
	<!--<div class="col-xs-2 deployed">
	...
	<div class="col-xs-2 deployed">
		...
		<input type="text" id="email_work" data-id="email_work" name="pe-email_work" class="form-control" placeholder="Рабочий e-mail" value="<?if(isset($_POST['pe-email_work'])) echo $_POST['pe-email_work'];?>" autocomplete="off" required>
		<div class="street_list">﻿<ul id='str_list'></ul></div>
	</div>
	<div class="col-xs-2 deployed">
		<label class="signature">Пароль e-mail</label>
		<input type="text" id="email_pass" data-id="email_pass" name="pe-email_pass" class="form-control" placeholder="пароль e-mail" value="<?if(isset($_POST['pe-email_pass'])) echo $_POST['pe-email_pass'];?>" autocomplete="off" required>
		<div class="street_list">﻿<ul id='str_list'></ul></div>
	</div>
	<br/>
	<br/>
