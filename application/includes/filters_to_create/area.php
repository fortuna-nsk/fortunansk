<?if ($parent == "Квартиры" || $parent == "Дома" || $parent == "Новостройки"){?>
	<div class="col-xs-2 deployed">
		...
		<div class="input-group interval">			
			<input type="text" id="sq_all" name="sq_all" class="form-control" placeholder="общ."  size="3" maxlength="3" value="<?php if($data_res['sq_all']) {echo $data_res['sq_all']; } ?>" required>
