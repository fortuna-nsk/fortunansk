...
<div class="col-xs-9">
	<?if($_SESSION["admin"] == 1){?>
		...
		<div class="col-xs-12">
			<form id="find_fio" action="?task=admin&action=find_fio" method="POST">
				<div class="col-xs-3">
	...
	<table class="table table-striped list">
		<thead><tr><th>#</th><th><input type="checkbox" data-name="check_all"></th><th>АН</th><th>Дата истечения аренды</th><th>Дата истечения продажи</th><th>Дата истечения частников 2</th></tr></thead>
		<tbody>
