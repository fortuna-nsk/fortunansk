...
<![endif]-->
		...
		<script type="text/javascript">
			$(function() {
				...
				//$("[name=pricefrom]").maskMoney({precision:'0', thousands :' '});
				//$("[name=priceto]").maskMoney({precision:'0', thousands :' '});
				//$("[name=price]").maskMoney({precision:'0', thousands :' '});
				//$("[data-id=price]").maskMoney({precision:'0', thousands :' '});
	...
	<body>
		...
		<div class="row footer" id="footer">
			<a href="/">fortunasib</a> &copy; 2008</a>
		</div>
